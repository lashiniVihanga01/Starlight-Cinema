...
@WebServlet(name = "configNS", value = "/configNS")
public class configNS extends HttpServlet {
    String searchName;
    int mID;
    String AddReady;
    String dltRec;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(dltRec!=null){
            ...
            try {
                ...
                connection = (Connection) DriverManager.getConnection("jdbc:mysql://database:3306/testmdb", "user", "password");

                statement = connection.createStatement();

                Integer flag;
                flag=statement.executeUpdate("DELETE FROM now_showing WHERE id = '" +Integer.parseInt(dltRec)+ "' ");
        ...
        if(mID!=0 && AddReady!=null){
            ...
            try{
                ...
                val=statement.executeUpdate("INSERT INTO now_showing VALUES('"+mID+"')");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            resultSet=statement.executeQuery("SELECT movies.id,movies.name,movies.release_date,movies.genre FROM movies INNER JOIN now_showing ON movies.id=now_showing.id");
